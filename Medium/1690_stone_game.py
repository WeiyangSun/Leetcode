...
class RecursiveSolution:
    def stoneGameVII(self, stones: list(int)) -> int:
        ...
        def recursive_helper(i, j) -> None:
            ...
            return total - min(
                stones[i] + recursive_helper(i + 1, j), stones[j] + recursive_helper(i, j - 1)
            )
    ...
    def stoneGameVII(self, stones: list(int)) -> int:
        ...
        def dfs(left_pointer: int, right_pointer: int) -> None:
            ...
            if memo[left_pointer][right_pointer] == 0:
                ...
                memo[left_pointer][right_pointer] = max(
                    range_sum - stones[left_pointer] - dfs(left_pointer + 1, right_pointer),
