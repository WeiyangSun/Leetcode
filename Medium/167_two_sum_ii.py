...
Return the indices of the two numbers, `index_1` and `index_2`, added by one as an integer array 
...
class Solution:
    def twoSum(self, numbers: List[int], target: int) -> List[int]:
        ...
        while left_pointer < right_pointer:
            ...
            if sum == target:
                return [left_pointer + 1, right_pointer + 1]  # convert to 1-index based
            elif sum < target:
                left_pointer += 1
            else:
                right_pointer -= 1
