...
The count-and-say sequence is a sequnce of digit strings defined by the
recursive formula:
...
string "3322251" we replace "33" with "23", replace "222" with "32",
replace "5" with "15" and replace "1" with "11". Thus the compressed
