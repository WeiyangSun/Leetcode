...
class Solution:
    def lastStoneWeight(self, stones: list(int)) -> int:
        ...
        while len(sorted_stones) > 1:
            biggest_stone, second_biggest_stone = sorted_stones.pop(), sorted_stones.pop()
            print(biggest_stone, second_biggest_stone)
            if biggest_stone != second_biggest_stone:
                resulting_stone = biggest_stone - second_biggest_stone
                sorted_stones.append(resulting_stone)
